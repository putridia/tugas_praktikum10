...
<?php
    $error_namaayah = "";
    $error_tahunlahirayah = "";
    $error_pendidikanayah = "";
    $error_pekerjaanayah = "";
    $error_penghasilanayah = "";
    $error_berkebutuhankhususayah = "";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["tahunlahirayah"])) {
            $error_tahunlahirayah = "Tahun Lahir Tidak Boleh Kosong";
        } else {
            $tahunlahirayah = cekinput($_POST["tahunlahirayah"]);
            if (!is_numeric($tanggallahirayah)) {
                $error_tahunlahirayah = "Tanggal Lahir Hanya Boleh Angka";
            }
        }
...
<div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="prosesdataayah.php">
                    ...
                    <div class="form-group row">
                        <label for="tahunlahirayah" class="col-sm-2 col-form-label">Tahun Lahir</label>
                        <div class="col-sm-10">
                            <input type="text" name="tahunlahirayah" id="tahunlahirayah" class="form-control <?php echo ($error_tahunlahirayah !="" ? "is-invalid" : ""); ?>" placeholder="" value="<?php echo $tahunlahirayah; ?>"> <span class="warning"><?php echo $error_tahunlahirayah ?></span>
                        </div>
                    </div><br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="col-sm-2 form-select" name="pendidikanayah">
                            <option value=""></option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="radio" name="penghasilanayah" value="< 500.000"> < 500.000 </label> <br>
                            <input type="radio" name="penghasilanayah" value="500.000 - 999.9999"> 500.000 - 999.9999 </label><br>
                            <input type="radio" name="penghasilanayah" value="1.000.000 - 1.999.999"> 1.000.000 - 1.999.999 </label><br>
                            <input type="radio" name="penghasilanayah" value="2.000.000 - 4.999.999"> 2.000.000 - 4.999.999 </label><br>
                            <input type="radio" name="penghasilanayah" value="5.0000.000 - 20.000.000"> 5.0000.000 - 20.000.000 </label> <br>
                            <input type="radio" name="penghasilanayah" value="20.000.000"> > 20.000.000 </label>
                            <span class="warning" ><?php echo $error_penghasilanayah; ?></span>
                        </div>
                    </div><br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="col-sm-2 form-select" name="berkebutuhankhususayah">
                            <option value=""></option>
                            ...
                            <span class="warning" ><?php echo $error_berkebutuhankhususayah; ?></span>
                        </div>
                    </div>
